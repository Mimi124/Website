...
@section('page_title', 'Testimonial - The Ministry of Sanitation and Water Resource')
@section('content')
...
<div class="content">
    ...
    <div class="container-fluid">
                            ...
                            <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="testimonial_title"
                                         value="{{ @$titles['testimonial_title'] }}">
                                    </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="testimonial_subtitle"
                                         value="{{ @$titles['testimonial_subtitle'] }}">
                                    </div>
                            </div>
        ...
        <ol class="breadcrumb m-0">
           <a href="{{route('testimonial.create')}}"  class="btn btn-sm btn-secondary waves-effect waves-light float-end">
                <i class="mdi mdi-plus-circle">Create Testimonial</i> </a>
        </ol>
                    </div>
