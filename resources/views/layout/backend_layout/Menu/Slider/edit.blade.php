                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Sliders</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
...
<div class="card">
    <div class="card-body">
        ...
        <div class="tab-pane" id="settings">
            ...
            <input type="text" name="subtitle" class="form-control" id="subtitle" value="{{ $slider->subtitle }}">
            ...
            <div class="col-md-8">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" id="description" rows="6">{{ $slider->description }}</textarea>
            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                        ...
                        <img id="image" src="{{  asset($slider->image) }}" class="rounded-circle avatar-lg img-thumbnail"
                                alt="slider-image">
                    </div>
                 </div> <!-- end col -->
